            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html">RecoFlower</a>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 responsive-wrap">
                    <div class="row detail-filter-wrap">
                        <div class="col-md-8 featured-responsive">
                            <input type="text" placeholder="꽃을 검색해보세요" class="btn-group1" style="width:100%; text-align: center" >
                        </div>
                ...
                <span class="custom-control-description">Smoking Allowed  </span>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
                            <label class="custom-control custom-checkbox">
                <input type="checkbox" name="checkbox" value="" class="custom-control-input">
                <span class="custom-control-indicator"></span>
