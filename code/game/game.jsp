        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 responsive-wrap">
                    <div align="center" class="booking-checkbox_wrap">
                        <div class="booking-checkbox story0">
                        	<div>
                        		<img style="height:200px;" src="./resources/images/hands.png">
                        	</div>
                    ...
                    <div align="center" class="booking-checkbox_wrap mt-4">
                    		<h5>1. 씨앗을 어디에 심을까요?</h5>
                        <div class="booking-checkbox story1">
							<img style="height:200px;" src="./resources/images/garden.jpg"><br>
							<div class="story">큰 나무와 꽃들이 무럭무럭 자라는 정원<br></div>
							<input type="radio" name="ground" value="00">여기에 심기<br><br>
				
							<img style="height:200px;" src="./resources/images/flowerpot.png"><br>
                        ...
                        <div class="booking-checkbox story3">
							<div class="col-md-6">
			                    <div class="reserve-seat-block">
			                        <div class="reserve-btn" align="right">
			                            <div class="featured-btn-wrap">                            	
			                            	<button class="button1 btn btn-danger" type="submit">꽃 피우기</button>
			                            </div>
			                        </div>
			                    </div>
			                </div>
